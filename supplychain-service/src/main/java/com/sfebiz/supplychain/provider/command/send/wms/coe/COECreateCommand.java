...
public class COECreateCommand extends WmsOrderCreateCommand {
    ...
    public boolean execute() {
        ...
        try {
            ...
            LogBetter.instance(logger).setLevel(LogLevel.INFO)
                    ...
                    .addParm("wmsProviderEntity", logisticsProviderBO)
                    .addParm("url信息", url)
    ...
    public LogisticsEventsRequest buildSalesStockoutRequest() {
        ...
        if ("ZTO".equalsIgnoreCase(eventBody.getClearanceDetail().carrierCode)) {
            ...
            paid.setPayCompanyName(PayConfig.getPayCompanyName(PayConfig.getPayProviderNidByPayType(stockoutOrderBO.getMerchantPayType())));
