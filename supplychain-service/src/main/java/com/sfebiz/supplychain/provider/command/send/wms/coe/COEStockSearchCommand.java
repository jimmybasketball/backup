...
public class COEStockSearchCommand extends WmsStockSearchCommand {
    ...
    public boolean execute() throws ServiceException {
        ...
        try {
            ...
            LogisticsEventsResponse responses = ProviderBizService.getInstance().send(logisticsEventsRequest, WmsMessageType.STOCK_SEARCH.getValue(), url, key, null);
