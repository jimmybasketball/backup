...
/**
 * 供应商同步
 * Created by yanmingming1989 on 6/25/15.
 */

public class ZebraSupplierSyncCommand extends WmsOrderSupplierSyncCommand {

    private static final String serviceName = "VendorSync";
    ...
    public boolean execute() {
        try {
            ...
            LogBetter.instance(logger)
                    ...
                    .log();
            LogisticsEventsResponse responses = ProviderBizService.getInstance().send(logisticsEventsRequest, WmsMessageType.SUPPLIER_SYNC.getValue(), url, key, null, ZebraConstants.PARTNER_CODE);
            LogBetter.instance(logger)
                    .setMsg("供应商同步响应报文")
