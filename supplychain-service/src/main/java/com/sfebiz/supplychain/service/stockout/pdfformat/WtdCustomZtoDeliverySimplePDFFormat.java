...
/**
 * 威时沛运清关, 中通配送的简单PDF面单格式
 * <p>
 * Created by jackiehff on 16/1/7.
 */
@Component("wtdCustomZtoDeliverySimplePDFFormat")
public class WtdCustomZtoDeliverySimplePDFFormat extends AbstractPDFFormat {

    private static final Logger logger = LoggerFactory.getLogger(WtdCustomZtoDeliverySimplePDFFormat.class);
...
//            }
    ...
    public String getFormat() {
        return PdfTemplateType.WTD_ZTO_SIMPLE.getValue();
    }
}
