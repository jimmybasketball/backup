 ...
 */
@Component("wtdCustomZtoDeliveryPDFFormat")
public class WtdCustomZtoDeliveryPDFFormat extends AbstractPDFFormat {

    private static final Logger logger = LoggerFactory.getLogger(WtdCustomZtoDeliveryPDFFormat.class);
...
//                wspLogo.setWidthPercentage(100);
//                wspLogo.scalePercent(80f);//设置缩放的百分比%7.5
//                cell.addElement(wspLogo);
//                cell.setFixedHeight(25f);
//                cell.setPadding(0);
//                cell.setBorder(0);
...
//            }
    ...
    public String getFormat() {
        return PdfTemplateType.WTD_ZTO.getValue();
    }
}
