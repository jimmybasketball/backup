 ...
 * Time: 下午3:56
 */
@Component("sFCustomDeliveryPDFFormat")
public class SFCustomDeliveryPDFFormat extends AbstractPDFFormat {

    private static final Logger logger = LoggerFactory.getLogger(SFCustomDeliveryPDFFormat.class);
    ...
    public PdfPTable buildPdfBill(ExportedShipOrderDO element, WarehouseDO warehouseDO, LogisticsLineDO logisticsLineDO, PdfContentByte cb) throws ServiceException {
        try {
            ...
            headerCell = new PdfPCell(new Paragraph("", BoldBigChinese));//描述
            ...
            headerCell.addElement(sfLogo);
            headerCell.setFixedHeight(50f);
            headerCell.setPadding(5f);
            headerCell.setBorder(0);
            headerTable.addCell(headerCell);

            headerCell = new PdfPCell(new Paragraph("E", BoldBigChinese));//描述
            headerCell.setHorizontalAlignment(Element.ALIGN_LEFT);// 设置内容水平居中显示
            headerCell.setVerticalAlignment(Element.ALIGN_MIDDLE);  // 设置垂直居中
            headerCell.setBorder(0);
            ...
            table1Cell = new PdfPCell(new Paragraph(" 国际特惠(试点)", BoldLittleBigChinese));
          ...
          //TODO 待确定
//            table2Cell = new PdfPCell(
//                    new Paragraph("月结账号:" + (StringUtils.isEmpty(logisticsLineBO.custId) ? "" : logisticsLineBO.custId), FontChinese));
            table2Cell.setColspan(5);
            ...
            table2Cell = new PdfPCell(
                    new Paragraph("托寄物声明价值:人民币" + AMOUNT_FORMAT.format(new BigDecimal(element.getPrice())) + "元",
                            FontChinese));
    ...
    public String getFormat() {
        return PdfTemplateType.SF_SF.getValue();
    }
}
