 ...
 */
@Component("gaoJieCustomZtoDeliveryPDFFormat")
public class GaoJieCustomZtoDeliveryPDFFormat extends AbstractPDFFormat {

    private static final Logger logger = LoggerFactory.getLogger(GaoJieCustomZtoDeliveryPDFFormat.class);
...
//        }
    ...
    public String getFormat() {
        return PdfTemplateType.GAOJIE_ZTO.getValue();
    }
}
