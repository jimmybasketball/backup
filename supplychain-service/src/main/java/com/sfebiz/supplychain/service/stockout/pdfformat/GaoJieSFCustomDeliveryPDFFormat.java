 ...
 * Time: 下午3:56
 */
@Component("gaoJieSFCustomDeliveryPDFFormat")
public class GaoJieSFCustomDeliveryPDFFormat extends AbstractPDFFormat {

    private static final Logger logger = LoggerFactory.getLogger(GaoJieSFCustomDeliveryPDFFormat.class);
...
//            cell.setColspan(2);
    ...
    public String getFormat() {
        return PdfTemplateType.GAOJIE_SF.getValue();
    }
}
