...
/**
 * 杭州优先投清关, 中通配送的简单PDF面单格式
 * <p>
 * Created by jackiehff on 16/1/7.
 */
@Component("yxtCustomZtoDeliverySimplePDFFormat")
public class YxtCustomZtoDeliverySimplePDFFormat extends AbstractPDFFormat {

    private static final Logger logger = LoggerFactory.getLogger(YxtCustomZtoDeliverySimplePDFFormat.class);
...
//            }
    ...
    public String getFormat() {
        return PdfTemplateType.YXT_ZTO_SIMPLE.getValue();
    }
}
