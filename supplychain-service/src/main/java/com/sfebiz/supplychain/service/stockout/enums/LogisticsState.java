...
public class LogisticsState extends Enumerable4IntValue {
    ...
    public static LogisticsState                                   LOGISTICS_STATE_INIT               = LogisticsState
                                                                                                          .valueOf(
                                                                                                              0,
                                                                                                              "初始化");
    public static LogisticsState                                   LOGISTICS_STATE_CREATE_SUCCESS     = LogisticsState
                                                                                                          .valueOf(
                                                                                                              1,
                                                                                                              "物流下单成功");
    public static LogisticsState                                   LOGISTICS_STATE_REFUSE             = LogisticsState
                                                                                                          .valueOf(
                                                                                                              2,
                                                                                                              "物流已拒单");
    public static LogisticsState                                   LOGISTICS_STATE_ACCEPT             = LogisticsState
                                                                                                          .valueOf(
                                                                                                              3,
                                                                                                              "海外仓已接受订单");
    public static LogisticsState                                   LOGISTICS_STATE_PACK_INSTOCK       = LogisticsState
                                                                                                          .valueOf(
                                                                                                              4,
                                                                                                              "海外仓包裹已收齐");

    public static LogisticsState                                   LOGISTICS_STATE_PACK_INSTOCK_ERROR = LogisticsState
                                                                                                          .valueOf(
                                                                                                              5,
                                                                                                              "海外包裹异常");
    public static LogisticsState                                   LOGISTICS_STATE_GOODS_WEIGHT       = LogisticsState
                                                                                                          .valueOf(
                                                                                                              6,
                                                                                                              "海外仓已称重回传");
    public static LogisticsState                                   LOGISTICS_STATE_EXCEPTION          = LogisticsState
                                                                                                          .valueOf(
                                                                                                              7,
                                                                                                              "回传仓内异常信息");
    public static LogisticsState                                   LOGISTICS_STATE_STOCKOUT_FREIGHT   = LogisticsState
                                                                                                          .valueOf(
                                                                                                              8,
                                                                                                              "海外仓运费已回传");
    public static LogisticsState                                   LOGISTICS_STATE_SEND_SUCCESS       = LogisticsState
                                                                                                          .valueOf(
                                                                                                              9,
                                                                                                              "下发发货指令成功");
    public static LogisticsState                                   LOGISTICS_STATE_STOCKOUT           = LogisticsState
                                                                                                          .valueOf(
                                                                                                              10,
                                                                                                              "海外仓已发货");
    public static LogisticsState                                   LOGISTICS_STATE_CANCEL             = LogisticsState
                                                                                                          .valueOf(
                                                                                                              11,
                                                                                                              "订单取消中");
    public static LogisticsState                                   LOGISTICS_STATE_CANCEL_SUCCESS     = LogisticsState
                                                                                                          .valueOf(
                                                                                                              12,
                                                                                                              "订单已取消");
    public static LogisticsState                                   LOGISTICS_STATE_CANCEL_ERROR       = LogisticsState
                                                                                                          .valueOf(
                                                                                                              13,
                                                                                                              "物流取消失败");
    // 14 的状态已废弃
    public static LogisticsState                                   LOGISTICS_STATE_CREATE_ERROR       = LogisticsState
                                                                                                          .valueOf(
                                                                                                              14,
                                                                                                              "物流下单失败");
    // 15 的状态已废弃
    public static LogisticsState                                   LOGISTICS_STATE_SEND_ERROR         = LogisticsState
                                                                                                          .valueOf(
                                                                                                              15,
                                                                                                              "物流发货失败");

    public static LogisticsState                                   LOGISTICS_STATE_TAX                = LogisticsState
                                                                                                          .valueOf(
                                                                                                              16,
                                                                                                              "关税回传");
    public static LogisticsState                                   LOGISTICS_STATE_WMS_CANCEL         = LogisticsState
                                                                                                          .valueOf(
                                                                                                              17,
                                                                                                              "仓库订单已取消");

    public static LogisticsState                                   LOGISTICS_STATE_COMPLETE           = LogisticsState
                                                                                                          .valueOf(
                                                                                                              200,
                                                                                                              "用户已签收");
