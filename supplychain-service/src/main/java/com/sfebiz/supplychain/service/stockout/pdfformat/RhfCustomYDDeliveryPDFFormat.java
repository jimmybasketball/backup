 ...
 *          下午2:58:07 matt Exp $
 */
@Component("rhfKoreaCustomYDDeliveryPDFFormat")
public class RhfCustomYDDeliveryPDFFormat extends AbstractPDFFormat {

	/** 日志 */
	private static final Logger logger = LoggerFactory
			.getLogger(RhfCustomYDDeliveryPDFFormat.class);
	...
	public PdfPTable buildPdfBill(ExportedShipOrderDO exportedShipOrderDO,
		...
		try {
			...
			Font fontChina = new Font(bfChinese, 6);
			Font fontSouthKorea = new Font(bfSouthKorea, 6);
			Font fontJapan = new Font(bfJapan, 6);
			...
			cell_t1_c1_t_c3.addElement(new Paragraph("寄件人:"
					+ exportedShipOrderDO.getSenderName(), hf_8_B));
			...
			cell_t1_c1_t_c4.addElement(new Paragraph("寄件人电话:"
					+ exportedShipOrderDO.getSenderTelephone(), hf_8_B));
			...
			cell_t1_c1_t_c6.addElement(new Paragraph("寄件人地址:"
					+ exportedShipOrderDO.getSenderAddress(), hf_8_B));
			cell_t1_c1_t.addCell(cell_t1_c1_t_c6);

			cell_t1_c1.addElement(cell_t1_c1_t);
			/*
			 * cell_t1_c1.addElement(new Paragraph("始发网点:", hf_8));
			 * cell_t1_c1.addElement(new Paragraph("寄件人:" +
			 * exportedShipOrderDO.getSenderName(), hf_8));
			 * cell_t1_c1.addElement(new Paragraph("寄件人电话:" +
			 * exportedShipOrderDO.getSenderTelephone(), hf_8));
			 * cell_t1_c1.addElement(new Paragraph("寄件公司:" +
			 * exportedShipOrderDO.getSenderName(), hf_8));
			 * cell_t1_c1.addElement(new Paragraph("寄件人地址:" +
			 * exportedShipOrderDO.getSenderCountry() +
			 * exportedShipOrderDO.getSenderProvince() +
			 * exportedShipOrderDO.getSenderCity() +
			 * exportedShipOrderDO.getSenderDistrict() +
			 * exportedShipOrderDO.getSenderAddress(), hf_8));
			 */
			...
			base_cell_2.setFixedHeight(NumberUtil.parseMmToPt(20.678f));

			PdfPTable base_cell_2_t = new PdfPTable(2);
			base_cell_2_t.setWidths(new int[] { 44, 56 });
			...
			Image qdNewLogo = qdLogo;
			qdNewLogo.scaleAbsolute(NumberUtil.parseMmToPt(42.018f), NumberUtil.parseMmToPt(40.018f));
			base_cell_2_t_c1.addElement(qdNewLogo);
			...
			wayBillImage.scaleAbsolute(NumberUtil.parseMmToPt(40),
			...
			base_cell_4.setFixedHeight(NumberUtil.parseMmToPt(10.81f));

			PdfPTable base_cell_4_t = new PdfPTable(2);
			base_cell_4_t.setWidths(new int[] { 74, 26 });
			base_cell_4_t.setWidthPercentage(100);
			PdfPCell base_cell_4_t_c1 = new PdfPCell();
			base_cell_4_t_c1.setBorder(0);
			base_cell_4_t_c1.addElement(new Paragraph("运单编号: "+exportedShipOrderDO.getIntrMailNo(), hf_12));
			base_cell_4_t.addCell(base_cell_4_t_c1);
			PdfPCell base_cell_4_t_c2 = new PdfPCell();
			base_cell_4_t_c2.setBorder(0);
			Image rhfLogo = rhfYdLogo;
			rhfLogo.scaleAbsolute(NumberUtil.parseMmToPt(35.018f), NumberUtil.parseMmToPt(30.18f));
			base_cell_4_t_c2.addElement(rhfLogo);
			 ...
			 * base_cell_6_t_c4.setBorder(0); base_cell_6_t_c4.setColspan(2);
			 * base_cell_6_t_c4.addElement(new Paragraph("总件数", hf_10));
			 * base_cell_6_t_c4.addElement(new
			 * Paragraph("快件类型 ShipmentType：□ 文件DOC □ 包裹Parcel", hf_10));
			 * base_cell_6_t.addCell(base_cell_6_t_c4);
			 */

			PdfPCell base_cell_6_t_c5 = new PdfPCell();
			base_cell_6_t_c5.setBorder(0);
			base_cell_6_t_c5.addElement(new Paragraph(exportedShipOrderDO
					.getIntrMailNo(), hf_10_B));
			base_cell_6_t.addCell(base_cell_6_t_c5);

			PdfPCell base_cell_6_t_c6 = new PdfPCell();
			base_cell_6_t_c6.setBorder(0);
			Barcode128 cell_6_t_c6_code128 = new Barcode128();
			cell_6_t_c6_code128.setFont(null);
			...
			base_cell_6_t_c6.addElement(cell_6_t_c6_Image);
			base_cell_6_t.addCell(base_cell_6_t_c6);
...
/*			// 8. 第八行
	...
	public String getFormat() {
		return PdfTemplateType.RHF_YUNDA.getValue();
	}
