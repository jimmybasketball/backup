 ...
 * Time: 下午4:21
 */
public class ZTOInternationOrderRequest implements ZTORequest {
     ...
     * 直邮业务的订单实体
     */
    private ZTOInternationOrderEntity orderEntity;
    ...
    public ZTOInternationOrderEntity getOrderEntity() {
        return orderEntity;
    }

    public void setOrderEntity(ZTOInternationOrderEntity orderEntity) {
