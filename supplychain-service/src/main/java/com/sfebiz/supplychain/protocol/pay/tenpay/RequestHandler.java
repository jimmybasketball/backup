...
import com.sfebiz.supplychain.protocol.pay.tenpay.util.MD5Util;
import com.sfebiz.supplychain.protocol.pay.tenpay.util.TenpayUtil;
...
public class RequestHandler {
    ...
    public String getRequestURL() throws UnsupportedEncodingException {
        ...
        String enc = TenpayUtil.getCharsetEncoding((String) parameters.get("input_charset"));
