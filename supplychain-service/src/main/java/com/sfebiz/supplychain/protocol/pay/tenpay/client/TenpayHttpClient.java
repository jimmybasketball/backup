...
import com.sfebiz.supplychain.protocol.pay.tenpay.util.HttpClientUtil;
...
public class TenpayHttpClient {
    ...
    private static final String JKS_CA_FILENAME =
            "tenpay_cacert_20160107112232.jks";
    ...
    public TenpayHttpClient() {
        ...
        this.responseCode = 0;
        this.charset = TencentPayConstants.CharSet.UTF8.getValue();
