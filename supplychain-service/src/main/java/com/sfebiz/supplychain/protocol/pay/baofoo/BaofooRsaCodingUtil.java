...
public final class BaofooRsaCodingUtil {
     ...
     * @return
     */
    public static String encryptByPriPfxFile(String src, String pfxPath, String priKeyPass) throws UnsupportedEncodingException {
     ...
     * @return
     */
    public static String encryptByPriPfxStream(String src, byte[] pfxBytes, String priKeyPass) throws UnsupportedEncodingException {
        PrivateKey privateKey = BaofooRsaReadUtil.getPrivateKeyByStream(pfxBytes, priKeyPass);
        if (privateKey == null) {
            return null;
        }
     ...
     * @param privateKey
     */
    public static String encryptByPrivateKey(String src, PrivateKey privateKey) throws UnsupportedEncodingException {

        //指定编码
        byte[] destBytes = rsaByPrivateKey(src.getBytes(BaofooRsaConst.ENCODE), privateKey, Cipher.ENCRYPT_MODE);
