...
public class WarehouseType extends Enumerable4StringValue {
    ...
    /** 国内仓 */
    public static WarehouseType DOMESTIC = WarehouseType.valueOf("DOMESTIC",
	    "国内仓");

    /** 保税仓 */
    public static WarehouseType BONDED = WarehouseType.valueOf("BONDED", "保税仓");

    /** 海外仓 */
    public static WarehouseType OVERSEAS = WarehouseType.valueOf("OVERSEAS",
	    "海外仓");

    /** 序号 */
    private static final long serialVersionUID = 4703251437337724030L;

    private static final Logger log = LoggerFactory
	    .getLogger(WarehouseType.class);
    ...
    public WarehouseType(String value, String name) {
	super(value, name);
    }
